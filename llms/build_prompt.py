...
HEADLINE_TEMPLATE = """你是一名严谨的中文新闻编辑，请用简体中文撰写栏目（日期：{date}）。
【写作要求】
1) 只写"{category}"栏目
...
4) 每条新闻单独成段
5) 全文必须是自然、通顺的简体中文
6) 若原始素材是英文或其他外文，必须先翻译成中文再写入正文
7) 除专有名词、机构名、URL、必要缩写外，不得输出整句英文或其他外文
8) 人名、地名、机构名优先使用常见中文译名；若确有必要，可在中文后补充英文原文一次
